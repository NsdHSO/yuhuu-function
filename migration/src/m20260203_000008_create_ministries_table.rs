        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Ministries::Uuid)
                            .uuid()
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(Ministries::Name)
                            .string()
                            .not_null()
                            .unique_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(Ministries::IsActive)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
                    ...
                    .col(
                        ColumnDef::new(Ministries::UpdatedAt)
                            .timestamp()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(
                                (Alias::new("church"), Ministries::Table),
                                Ministries::LeaderId,
                            )
                            .to(
